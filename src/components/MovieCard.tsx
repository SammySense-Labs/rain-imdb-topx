...
export const MovieCard: React.FC<MovieCardProps> = ({ movie, rank }) => {
  return (
    <Link href={`/movies/${movie.id}`} className="block group focus:outline-none">
      <div className="relative bg-[#231942]/80 rounded-xl overflow-hidden shadow-lg flex flex-col h-full transition-transform group-hover:scale-105 group-hover:shadow-2xl">
        {/* Rank badge */}
